...
- Daily office use occurs in the separate `/office/` workspace. Its authorization can reach only the route-assignment workflow; the executive cockpit remains a management-only surface. Management owns office account creation and deactivation from Route Intelligence.
