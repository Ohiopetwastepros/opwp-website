...
export function validateOnboardingInput(body) {
  ...
  if (!value.first_name || !value.last_name || !value.email || !value.cell_phone_number || !value.home_address || !value.city || !["OH", "MI"].includes(value.state) || !value.zip_code || !Number.isInteger(value.number_of_dogs) || value.number_of_dogs < 1 || value.number_of_dogs > 20 || value.terms_open_api !== 1) {
